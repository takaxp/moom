...
Note: When =moom-font-module-p= is =nil=, font size is fixed except for =moom-reset= even if ~moom-font.el~ is loaded.
...
| moom-horizontal-shifts               |                   '(40 40) | choice  |
| moom-font-module-p                   | (require 'moom-font nil t) | sexp    |
