...
Note 2 - This module supports multi monitors for macOS, Windows 10 and Ubuntu 20.04. From version 1.4.1, =moom-multi-monitors-support= is non-nil as default so no need to change the setting in your init.el.
